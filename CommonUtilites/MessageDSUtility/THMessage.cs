/////////////////////////////////////////////////////////////////////
//  THMessages.cs -TestHarness messages           //
//  ver 1.0                                                        //
...
Uses this class for sending messages to test harness 

contains classes like TestRequest,TestElements,TestResult,TestResults
...
namespace MessageDS
{
    ...
    class TestTHMessages
    {
        static void Main(string[] args)
        {
            ...
            ObjectHandle handle = Activator.CreateInstance("RequestProcessor", "RequestProcessor." + rqstMsg.type);
            Object p = handle.Unwrap();
            Type type = p.GetType();
            MethodInfo method = type.GetMethod("processRequests");

            method.Invoke(p, new object[] { rqstMsg.body });
